...
const ZONES = {
  ...
  town_outskirts: {
    ...
    monsters: ['stray_dog','feral_cat','giant_rat','plague_bat','goblin_scout','bandit_thug','corrupt_farmer','hollow_scarecrow','mud_crab','bone_imp'],
    icon: '🌾',
    minLevel: 1,
  ...
  forest_path: {
    ...
    canFight: true, canExplore: true,
    monsters: ['vine_serpent','forest_boar','forest_wolf','goblin_warrior','giant_spider','goblin_shaman','giant_hornet','stone_golem_shard','shadow_elk','ancient_treant'],
    icon: '🌲',
    minLevel: 3,
  ...
  dark_cave: {
    ...
    canFight: true, canExplore: true,
    monsters: ['cave_bat','cave_spider','crystal_lizard','blind_stalker','dark_dwarf','ghost_miner','rock_elemental','cave_wyrm','cave_troll','void_wisp'],
    icon: '🕳️',
    minLevel: 5,
  ...
  city_ruins: {
    ...
    canFight: true, canExplore: true,
    monsters: ['ruined_knight','tomb_revenant','plague_rat','city_ghoul','bone_archer','rust_golem','void_spawn','shadow_rogue','forsaken_mage','iron_golem_shard'],
    icon: '🏚️',
    minLevel: 10,
  ...
  cursed_marshlands: {
    ...
    canFight: true, canExplore: true,
    monsters: ['poison_frog','mud_golem','bog_lurker','will_o_wisp','swamp_wraith','thornback_turtle','giant_leech','bog_witch','nightmare_croc','marsh_basilisk'],
    icon: '🌿',
    minLevel: 18,
  ...
  void_frontier: {
    ...
    canFight: true, canExplore: true,
    monsters: ['void_shade','void_stalker','void_spawn_greater','dimensional_horror','phase_wraith','soul_harvester','reality_eater','void_titan','null_guardian','chaos_elemental'],
    icon: '🌀',
    minLevel: 28,
  ...
  shadowfell_depths: {
    ...
    canFight: true, canExplore: true,
    monsters: ['shadow_wraith','death_reaper','nightmare_hound','dark_elemental','dark_knight','void_knight','shadow_assassin','soul_devourer','corruption_shade','infernal_demon'],
    icon: '🌑',
    minLevel: 38,
  ...
  vorath_citadel: {
    ...
    canFight: true, canExplore: true,
    monsters: ['iron_warden','shadow_construct','citadel_sentinel','void_colossus','void_reaper','void_priest','chaos_sorcerer','ancient_lich','abyssal_dragon','citadel_horror'],
    icon: '🏰',
    minLevel: 50,
