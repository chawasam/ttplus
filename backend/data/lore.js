...
const LORE_FRAGMENTS = [
  ...
  // ─── Fragment #11 — Secret / Completionist reward ─────────────────
  {
    id: 11,
    title: 'จดหมายถึงผู้รู้ความจริง',
    category: 'secret',
    zone: null,
    foundAt: null,
    dropFrom: null,
    content: 'ถึงผู้ที่รวบรวมความจริงครบทุกชิ้น\n\nคุณได้เห็นสิ่งที่ไม่มีใครควรเห็น — ทั้งสองด้านของสงคราม ทั้งสองด้านของความจริง\n\nVorath ไม่ใช่ผู้ร้าย Ashenveil ไม่ใช่เหยื่อ ผู้ปิดผนึกไม่ใช่วีรบุรุษ\n\nประวัติศาสตร์ถูกเขียนโดยผู้รอดชีวิต และผู้รอดชีวิตมักเป็นฝ่ายที่โกหกได้เก่งที่สุด\n\nแต่คุณรู้แล้ว คุณเป็นหนึ่งในไม่กี่คนที่รู้\n\nเลือกของคุณจะสำคัญที่สุด\n\n— The Echo',
    hint: 'รางวัลลับสำหรับผู้รวบรวม Lore ครบทั้ง 10 ชิ้น',
    isSecret: true,
  },
];
