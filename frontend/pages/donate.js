    ...
    <div className={clsx('min-h-screen', theme === 'dark' ? 'bg-gray-950 text-white' : 'bg-gray-100 text-gray-900')}>
      ...
      <main className="ml-16 md:ml-56 p-4 md:p-6 max-w-2xl">
        ...
        <div className={clsx('rounded-2xl p-6 text-center mb-6', theme === 'dark' ? 'bg-gray-900 border border-gray-800' : 'bg-white border border-gray-200 shadow-sm')}>
          ...
          <h2 className={clsx('text-xl font-bold mb-2', theme === 'dark' ? 'text-white' : 'text-gray-900')}>สนับสนุนการพัฒนา</h2>
          <p className={clsx('text-sm mb-6', theme === 'dark' ? 'text-gray-400' : 'text-gray-500')}>TTplus เป็นบริการฟรี ถ้าชอบและอยากให้พัฒนาต่อเนื่อง สามารถสนับสนุนได้เลยครับ</p>
          <div className="space-y-3">
            ...
            <a href="https://ko-fi.com/YOUR_USERNAME" target="_blank" rel="noreferrer"
            ...
            <div className={clsx('rounded-xl p-4 text-center', theme === 'dark' ? 'bg-gray-800' : 'bg-gray-100')}>
              <p className={clsx('text-sm font-semibold mb-1', theme === 'dark' ? 'text-white' : 'text-gray-900')}>💳 PromptPay</p>
              <p className="text-lg font-bold text-brand-400">0XX-XXX-XXXX</p>
            </div>
          </div>
        </div>
        <p className={clsx('text-center text-xs', theme === 'dark' ? 'text-gray-600' : 'text-gray-400')}>ขอบคุณทุกการสนับสนุนครับ 🙏</p>
      </main>
    </div>
  );
}
